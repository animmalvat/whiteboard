...
//                    }
                ...
                <li><a href="http://localhost/projectv2/php/faculty/faculty_subject_material.php" class='active'>Subject Material</a></li>
    ...
    <section class="canvas fl-left">
        ...
        <div class="work1">
            <div class="news" style="width:80%; height:70%;" id="table">
                <h1>
                    Please fill up the form to upload material
                </h1>
                <form action="http://localhost/projectv2/php/faculty/faculty_subject_material_upload.php" method="post" enctype="multipart/form-data">
                    <br>
                    <br>
                    Subject
                    <?php
                        //fetching subjects taught by the faculty
                        $sql = "select assigned_subject.*, subject.name from assigned_subject inner join subject on subject.id = assigned_subject.subject_id where faculty_id = '$user_id'";
                    ...
                    <input class="input100" type="file" name="material" id="material" style='margin: 0 auto; position: relative;' />
